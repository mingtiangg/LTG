...
var BRS = (function(BRS, $, undefined) {
    ...
    BRS.applyRedemptionRequest = function(url, data, callback, async) {
        if ($.isFunction(data)) {
            async = callback;
            callback = data;
            data = {};
    ...
    BRS.pledgeRequest = function(url, data, callback, async) {
        if ($.isFunction(data)) {
            async = callback;
            callback = data;
            data = {};
    ...
    BRS.verifyAndSignTransactionBytes = function(transactionBytes, signature, requestType, data) {
        ...
        if (!("recipient" in data)) {
            //recipient == genesis
            data.recipient = "0";
            data.recipientRS = "LTG-2222-2222-2222-22222";
        }
