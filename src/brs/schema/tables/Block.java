...
public class Block extends TableImpl<BlockRecord> {
    ...
    private static final long serialVersionUID = -1957189357;
    ...
    public brs.schema.tables.Block constraint_3c() {
        return new brs.schema.tables.Block(this, Keys.CONSTRAINT_3C);
    }

    public brs.schema.tables.Block constraint_3c5() {
        return new brs.schema.tables.Block(this, Keys.CONSTRAINT_3C5);
    }
