...
public class Transaction extends TableImpl<TransactionRecord> {
    ...
    private static final long serialVersionUID = 1234445380;
    ...
    /**
     * The column <code>DB.transaction.trans_type</code>.
     */
    public final TableField<TransactionRecord, Byte> TRANS_TYPE = createField("trans_type", org.jooq.impl.SQLDataType.TINYINT.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "");

    /**
     * The column <code>DB.transaction.ransom_time</code>.
     */
    public final TableField<TransactionRecord, Long> RANSOM_TIME = createField("ransom_time", org.jooq.impl.SQLDataType.BIGINT, this, "");
