...
public class AccountRecord extends UpdatableRecordImpl<AccountRecord> implements Record14<Long, Long, Integer, byte[], Integer, Long, Long, Long, String, String, Integer, Boolean, Integer, Long> {

    private static final long serialVersionUID = 2025901153;
    ...
    /**
     * Setter for <code>DB.account.level</code>.
     */
    ...
    /**
     * Getter for <code>DB.account.level</code>.
     */
    ...
    /**
     * Setter for <code>DB.account.pledge</code>.
     */
    public void setPledge(Long value) {
        set(13, value);
    }

    /**
     * Getter for <code>DB.account.pledge</code>.
     */
     ...
     */
    @Override
    public Row14<Long, Long, Integer, byte[], Integer, Long, Long, Long, String, String, Integer, Boolean, Integer, Long> fieldsRow() {
     ...
     */
    @Override
    public Row14<Long, Long, Integer, byte[], Integer, Long, Long, Long, String, String, Integer, Boolean, Integer, Long> valuesRow() {
     ...
     */
    @Override
    public AccountRecord values(Long value1, Long value2, Integer value3, byte[] value4, Integer value5, Long value6, Long value7, Long value8, String value9, String value10, Integer value11, Boolean value12, Integer value13, Long value14) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AccountRecord(Long dbId, Long id, Integer creationHeight, byte[] publicKey, Integer keyHeight, Long balance, Long unconfirmedBalance, Long forgedBalance, String name, String description, Integer height, Boolean latest, Integer level, Long pledge) {
        super(Account.ACCOUNT);
