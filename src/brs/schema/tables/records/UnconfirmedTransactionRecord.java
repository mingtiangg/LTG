...
public class UnconfirmedTransactionRecord extends UpdatableRecordImpl<UnconfirmedTransactionRecord> implements Record9<Long, Long, Integer, Integer, Long, Integer, byte[], Integer, Byte> {

    private static final long serialVersionUID = 748708466;
    ...
    /**
     * Setter for <code>DB.unconfirmed_transaction.trans_type</code>.
     */
    public void setTransType(Byte value) {
        set(8, value);
    }

    /**
     * Getter for <code>DB.unconfirmed_transaction.trans_type</code>.
     */
     ...
     */
    @Override
    public Row9<Long, Long, Integer, Integer, Long, Integer, byte[], Integer, Byte> fieldsRow() {
     ...
     */
    @Override
    public Row9<Long, Long, Integer, Integer, Long, Integer, byte[], Integer, Byte> valuesRow() {
    ...
    public Field<Byte> field9() {
        return UnconfirmedTransaction.UNCONFIRMED_TRANSACTION.TRANS_TYPE;
    }
     ...
     */
    @Override
    public UnconfirmedTransactionRecord value9(Byte value) {
        setTransType(value);
        return this;
    }
     ...
     */
    @Override
    public UnconfirmedTransactionRecord values(Long value1, Long value2, Integer value3, Integer value4, Long value5, Integer value6, byte[] value7, Integer value8, Byte value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UnconfirmedTransactionRecord(Long dbId, Long id, Integer expiration, Integer transactionHeight, Long feePerByte, Integer timestamp, byte[] transactionBytes, Integer height, Byte transType) {
        super(UnconfirmedTransaction.UNCONFIRMED_TRANSACTION);
